...
<div>
	...
	<label><?php _e('Utilisateur') ?>:<br /><input onkeypress="return al_loginOnEnter(event);" type="text" name="log" value="" size="20" tabindex="7" /></label><br />
    <label><?php _e('Mot de passe') ?>:<br /> <input onkeypress="return al_loginOnEnter(event);" type="password" name="pwd" value="" size="20" tabindex="8" /></label><br />
...
<h3>Retrouver le mot de passe</h3>
<hr/>
<div>
    <form name="al_lostPasswordForm" onsubmit="return false;" id="al_lostPasswordForm" action="#" method="post">
	<label><?php _e('Utilisateur') ?>:<br /><input onkeypress="return al_retrievePasswordOnEnter(event);" type="text" name="user_login" value="" size="20" tabindex="7" /></label><br />
    ...
    <span id="al_lostPasswordMessage">Une confirmation sera envoyée dans votre boite e-mail.<br/></span>

    <a href="javascript:al_showLogin();">Connexion</a> | <a href="javascript:al_showRegister();">S'inscrire</a>
    </form>
</div>
</div>
...
<hr/>
<div>
    <a href="<?php echo get_settings('siteurl') . '/wp-login.php?action=logout&amp;redirect_to=' . $_SERVER['REQUEST_URI']; ?>"><?php _e('Déconnexion'); ?></a>
</div>
</div>
