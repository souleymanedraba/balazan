...
Simple:Press
Forum View Class
$LastChangedDate: 2013-12-18 05:16:08 -0800 (Wed, 18 Dec 2013) $
$Rev: 10928 $
*/
...
class spForumView {
	...
	function sp_forumview_subforums_query($subs, $top = false) {
		...
		$spdb = new spdbComplex;
			$spdb->table	= SFFORUMS;
			$spdb->fields	= 'forum_id, forum_name, forum_slug, forum_desc, forum_seq, forum_status, forum_disabled, forum_icon, forum_icon_new, topic_icon, topic_icon_new, forum_rss_private,
